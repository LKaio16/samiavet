...
@Entity
@Table(name="servicosPrestadosTemp")
public class ServicosPrestadosTemp {
	...
	public ServicosPrestadosTemp(Long idServico, Double valor, Double taxa, int parcelas, String data_venda,
